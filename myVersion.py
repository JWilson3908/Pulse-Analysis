...
class timetotemp:
    ...
    Tc(22) = 2.293 mK
    Tc(9psi) = 1.013 mK
    Tc (425 psi) = 2.4292 mK '''
    def __init__(self,*nums):
        self.tc=[0.929,1.013,2.293,2.4292] # list of Tc for experiments
        self.num_exp=nums[0]
        self.num1=nums[1]
        self.num2=nums[2]
        self.offset=nums[3]
...
#            self.dir="f:\\data\\old_hdd_dima\\d\\therm_transport\\data\\0bar\\2018FEB\\" # home dir 0 Bar
        self.dir="C:\\Users\\John Wilson\\Documents\\Cornell REU\\Data\\All Data\\" # work dir
        # Fork 1
...
B=timetotemp(10,2000,30050,250)
